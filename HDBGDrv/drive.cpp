...
#include <hvm\hvm_lib\include\loader.h>
#include <hvm\hvm_lib\include\sdk.h>
...
extern"C" NTSTATUS DriverEntry(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
    ...
    do
    {
        ...
        //初始化Kernel
        if (!HvmInitialize(DriverObject->DriverStart, DriverObject->DriverSize, _HvmHeapBaseAddress, HvmHeapSize
